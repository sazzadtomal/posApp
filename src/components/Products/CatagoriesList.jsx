...
const CatagoriesList = () => {
  ...
  return (
    visible ? <div className="fixed w-full h-full z-[50]">
      ...
      <div className=" bg-white absolute right-0  w-1/2 lg:w-1/3 h-full flex flex-col items-center py-6 px-8 gap-8  ">
          <div className="text-2xl text-black">Catagories</div>

          <div className="flex flex-wrap gap-2 [&>*]:px-4 [&>*]:py-2  [&>*]:bg-white [&>*]:border">
